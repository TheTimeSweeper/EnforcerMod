...
namespace Modules {
    internal static class Buffs {
        ...
        internal static void RegisterBuffs() {
            ...
            nemforcerRegenBuff = AddNewBuff("NemforcerRegen", Addressables.LoadAssetAsync<BuffDef>("RoR2/Base/Croco/bdCrocoRegen.asset").WaitForCompletion().iconSprite, new Color32(210, 50, 22, 255), false, false);
