...
namespace Modules
{
    ...
    internal static class Prefabs
    {
        ...
        internal static CharacterModel SetupCharacterModel(GameObject prefab, Modules.Characters.CustomRendererInfo[] customInfos) {
        ...
        internal static void SetupHurtBoxes(HealthComponent healthComponent) {
            //if the prefab was built with hurtboxes setup
            foreach (HurtBoxGroup hurtboxGroup in healthComponent.GetComponentsInChildren<HurtBoxGroup>()) {
