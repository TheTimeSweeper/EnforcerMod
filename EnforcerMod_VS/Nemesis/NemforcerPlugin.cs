...
namespace EnforcerPlugin {
    public class NemforcerPlugin
    {
        ...
        private void PrimarySetup() {
            ...
            Modules.Content.AddEntityState(typeof(NemHammerSwing),
                                           typeof(ThrowHammer));
        ...
        private static SkillDef PrimarySkillDef_Hammer()
        {
            ...
            mySkillDef.activationState = new SerializableEntityStateType(typeof(EntityStates.Nemforcer.NemHammerSwing));
