...
namespace EnforcerMain
{
    ...
    public class EnforcerMain : BaseUnityPlugin
    {
        ...
        private void RegisterCharacter()
        {
            ...
            string desc = "Bruh<color=#CCD3E0>" + Environment.NewLine + Environment.NewLine;
